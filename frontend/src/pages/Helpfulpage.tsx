  ...
  return (
    <div className="w-full flex flex-col items-center p-6 bg-gray-50 min-h-screen">
      ...
      <div className="w-full max-w-3xl text-center border p-6 bg-white rounded-xl shadow-sm mb-8">
        <h1 className="text-3xl font-bold mb-2">ベトナム的料理実施ガイド</h1>
        <p className="text-gray-600 text-sm">Helpful Japanese Phrases for Food & Invitations</p>
      </div>
      ...
      <div className="w-full max-w-3xl border p-6 bg-white rounded-xl shadow-md space-y-6">
        ...
        <div className="bg-green-100 p-4 rounded-lg">
          <h2 className="font-bold text-lg mb-2">1. 誘う (Inviting)</h2>
        ...
        <div className="bg-orange-100 p-4 rounded-lg">
          <h2 className="font-bold text-lg mb-2">2. 質問する (Asking Questions)</h2>
          <p>牛肉の、何料理？</p>
          <p>パクチは好き？</p>
          <p>好きな家庭料理なのなに？</p>
        </div>
        ...
        <h2 className="font-bold text-lg mb-2">3. 会話例 (Sample Dialogue)</h2>
